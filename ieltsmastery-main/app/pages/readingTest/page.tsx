  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 font-serif">
      ...
      <div className="flex flex-col sm:flex-row justify-center">
        {/* Left Section: Buttons and Questions */}
        <div className="w-full sm:w-1/2 flex flex-col space-y-6 pr-8">
          {/* Test Categories */}
          <div className="bg-white shadow-md rounded-md p-6">
            <h3 className="text-lg font-bold mb-4">Test Categories</h3>
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-4">
              {['Listening', 'Reading', 'Writing', 'Speaking'].map((category, index) => (
                <button
                  key={index}
        ...
        {/* Right Section: Reading Material */}
        <div className="w-full sm:w-1/2 bg-white shadow-md rounded-md p-6 mt-6 sm:mt-0">
